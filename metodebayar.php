...
<body id="page-top">
        ...
        <div class="container-fluid">
		  ...
		  <div class="card shadow mb-4">
			...
			<br>
		<center>
		<h6 class="m-0 font-weight-bold text-primary">Pilih Salah satu metode pembayaran dibawah ini :</h6>
        <br>
		<a href="dana.php" class="btn-sm btn-success"> VIA DANA</a>
		<a href="tunai.php" class="btn-sm btn-success"> TUNAI</a>
