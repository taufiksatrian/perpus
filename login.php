...
<head>
  ...
  <title>Sistem Informasi Manajemen Buku</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?page=dashboard">
        <div class="sidebar-brand-text mx-3">S I P<sup></sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="cetakanggota.php">Cetak Anggota</a>
            <a class="collapse-item" href="cetakbuku.php">Cetak Buku</a>
            <a class="collapse-item" href="?page=cetakpeminjaman">Cetak Pengembalian</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Charts -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="img/fp.jpg">
              </a>
