...
<body onload="start_timer()">
        ...
        <div class="container-fluid">
		  ...
		  <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary" align="center"> Metode Pembayaran Tunai</h6>
            </div>
            <div class="card-body">
		...
		<h5 class="m-0 font-weight-bold text-primary" > Silahkan Bayar Sebesar "Rp <?php echo $denda1; ?>" Secara Tunai/Cash kepada Petugas <br>Di Lokasi Perpustakaan Sebelum Waktu Habis</h5>
        <br>
		...
		1. Datang Ke Lokasi Perpustakaan. <br>
		2. Bilang ke Petugas untuk pembayaran Denda. <br>
		3. Sebutkan ID Anggota kepada petugas <br>
		4. Kemudian Serahkan Uang Rp <?php echo $denda1; ?> kepada Petugas <br>
